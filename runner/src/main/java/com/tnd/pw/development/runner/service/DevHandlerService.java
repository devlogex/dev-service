...
public interface DevHandlerService {
    ...
    CsDevRepresentation calculateFeature(DevRequest request) throws DBServiceException, FeatureNotFoundException, ReleaseNotFoundException, ActionServiceFailedException;
}
