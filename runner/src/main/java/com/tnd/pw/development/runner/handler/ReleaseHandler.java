...
public class ReleaseHandler implements BaseHandler {
    ...
    public BaseResponse<CsDevRepresentation> addRelease(DevRequest request) throws DBServiceException, ReleaseNotFoundException {
    ...
    public BaseResponse<CsDevRepresentation> getRelease(DevRequest request) throws DBServiceException, ReleaseNotFoundException {
    ...
    public BaseResponse<CsDevRepresentation> removeRelease(DevRequest request) throws DBServiceException, ReleaseNotFoundException {
    ...
    public BaseResponse<CsDevRepresentation> addReleasePhase(DevRequest request) throws DBServiceException, ReleasePhaseNotFoundException {
    ...
    public BaseResponse<ReleasePhaseRep> getReleasePhaseInfo(DevRequest request) throws DBServiceException, ReleasePhaseNotFoundException, ActionServiceFailedException {
    ...
    public BaseResponse<CsDevRepresentation> getReleasePhase(DevRequest request) throws DBServiceException, ReleasePhaseNotFoundException {
    ...
    public BaseResponse<ReleasePhaseRep> updateReleasePhase(DevRequest request) throws DBServiceException, ReleasePhaseNotFoundException, ActionServiceFailedException {
    ...
    public BaseResponse<CsDevRepresentation> removeReleasePhase(DevRequest request) throws DBServiceException, ReleasePhaseNotFoundException {
    ...
    public BaseResponse<CsDevRepresentation> addEpic(DevRequest request) throws DBServiceException, EpicNotFoundException {
    ...
    public BaseResponse<CsDevRepresentation> getEpic(DevRequest request) throws DBServiceException {
    ...
    public BaseResponse<EpicRep> geEpicInfo(DevRequest request) throws DBServiceException, EpicNotFoundException, ActionServiceFailedException {
    ...
    public BaseResponse<CsDevRepresentation> removeEpic(DevRequest request) throws DBServiceException, EpicNotFoundException {
