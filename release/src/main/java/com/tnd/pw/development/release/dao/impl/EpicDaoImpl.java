...
public class EpicDaoImpl implements EpicDao {
    ...
    private static final String SQL_UPDATE =
            "UPDATE epic SET name = '%s', state = %d, release_id = %d, initiatives = '%s', goals = '%s', " +
                    "assign_to = %d, description = '%s', files = '%s', start_on = %d, end_on = %d " +
                    "WHERE id = %d";
    ...
    public void create(EpicEntity entity) throws DBServiceException {
        String query = String.format(SQL_CREATE, entity.getId(), entity.getProductId(), entity.getName(),
                entity.getState(), entity.getReleaseId(), entity.getDescription(), entity.getFiles(),
    ...
    @Override
    public List<EpicEntity> get(List<Long> ids) throws DBServiceException, EpicNotFoundException {
        String listId = "";
    ...
    public void update(EpicEntity entity) throws DBServiceException {
        String query = String.format(SQL_UPDATE, entity.getName(), entity.getState(),entity.getReleaseId(),
                ...
                entity.getFiles(), entity.getStartOn(), entity.getEndOn(), entity.getId());
        dataHelper.executeSQL(query);
    }
